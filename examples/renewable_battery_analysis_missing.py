...
def main(cfg):
    cfg_list = cfg.capacity_tuple.lstrip("(").rstrip(")").split(",")
    print(f"tuple: {cfg_list}")
    wind_system_capacity = int(cfg_list[0])
    print(f"wind_system_capacity: {wind_system_capacity}")
    solar_system_capacity = int(cfg_list[1])
    print(f"solar_system_capacity: {solar_system_capacity}")
    battery_capacity = int(cfg_list[2])
    ...
    farm_layout = automatic_farm_layout(
        desired_farm_size=wind_system_capacity,
    ...
    wind_config = {
        **wind_config,
        **farm_layout,
        "system_capacity": wind_system_capacity,
    ...
    environment.run(until=24 * 3600 * 1)  # in days
