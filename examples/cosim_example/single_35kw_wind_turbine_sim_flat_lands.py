...
if __name__ == "__main__":
    run_simulation(
        carbon_aware=True,
        result_csv="data_single_35kw_wind_turbine_sim_flat_lands.csv",
        weather_data_file="../data/WIND-Toolkit_lat44.32_lon-74.13_2014_5min_flat_lands_northern_ny.csv",
