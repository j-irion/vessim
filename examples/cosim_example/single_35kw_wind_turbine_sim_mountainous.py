...
if __name__ == "__main__":
    run_simulation(
        carbon_aware=True,
        result_csv="data_single_35kw_wind_turbine_sim_mountainous.csv",
        weather_data_file="../data/WIND-Toolkit_lat43.68_lon-114.36_2014_5min_mountainous_southern_id.csv",
