...
def run_simulation(carbon_aware: bool, result_csv: str, weather_data_file: str, sam_input: str):
    ...
    wind = wind_sim.Generator(generator=WindGenerator(weather_data_file, sam_input))
...
if __name__ == "__main__":
    run_simulation(
        carbon_aware=True,
        result_csv="data_single_35kw_wind_turbine_sim_rolling_hills.csv",
        weather_data_file="../data/WIND-Toolkit_lat35.13_lon-117.99_2014_5min_rolling_hills_southern_ca.csv",
        sam_input="../data/single_endurance_g3120_19.2m_35kw.json",
    )
